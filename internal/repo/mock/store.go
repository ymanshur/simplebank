...
// Source: github.com/ymanshur/simplebank/internal/repo (interfaces: Store)
...
func (m *MockStore) CreateUserTx(arg0 context.Context, arg1 repo.CreateUserTxParams) (repo.CreateUserTxResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateVerifyEmail(arg0 context.Context, arg1 repo.CreateVerifyEmailParams) (repo.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateVerifyEmail(arg0 context.Context, arg1 repo.UpdateVerifyEmailParams) (repo.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) VerifyEmailTx(arg0 context.Context, arg1 repo.VerifyEmailTxParams) (repo.VerifyEmailTxResult, error) {
	m.ctrl.T.Helper()
